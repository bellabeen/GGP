...
void setup()
 ...
 void start_GSM(){
    ...
    delay(2000);
    Serial.println("AT+SAPBR=3,1,\"USER\",\"wap\"");
    delay(2000);
    Serial.println("AT+SAPBR=3,1,\"PWD\",\"wap123\"");
    delay(2000);
 ...
 void send_GPRS(){
          ...
          //Serial.print("AT+HTTPPARA=\"URL\",\"http://localhost/webserver/geo2_0.php/geo/geo2_0.php?latitude=");
          Serial.print("AT+HTTPPARA=\"URL\",\"http://localhost/webserver/geo2_0.php?latitude=");
 ...
 void start_GPS(){
    ...
    Serial.print("AT");
    delay(1000);
    Serial.println("AT+CGPSIPR=115200");// (set the baud rate)
    delay(1000);
